...
// };
    ...
    enum ScreensEnum {
        ...
        SCREEN_ID_CALIBRATION_PAGE = 4,
        SCREEN_ID_LOWPOWER_PAGE = 5,
    };
#else
    enum ScreensEnum {
        SCREEN_ID_LANGUAGE_PAGE = 1,
        SCREEN_ID_CALIBRATION_PAGE = 2,
        SCREEN_ID_ABOUT_PAGE = 3,
        SCREEN_ID_LOWPOWER_PAGE = 4,
    };
#endif

#ifdef USE_TDS
#define UI_FIRST_CYCLING_SCREEN SCREEN_ID_MEASURE_TDS
#elif defined(USE_TEMP)
#define UI_FIRST_CYCLING_SCREEN SCREEN_ID_MEASURE_TEMP
#else
#define UI_FIRST_CYCLING_SCREEN SCREEN_ID_LANGUAGE_PAGE
#endif
